...
//        }
    ...
    private void initComponents() {
        ...
        tblSinhVien.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã SV", "Tên", "Ngày Sinh", "Địa Chỉ", "Chiều cao", "Cân Năng", "Trường Đang Học", "Năm Học", "Điểm TB", "id"
            }
        ) {
    ...
    private void tblSinhVienMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblSinhVienMouseClicked
        ...
        txtChieuCao.setText(tblSinhVien.getValueAt(row, 4).toString());
        txtCanNang.setText(tblSinhVien.getValueAt(row, 5).toString());
        txtTruongDangHoc.setText(tblSinhVien.getValueAt(row, 6).toString());
        txtNamBatDau.setText(tblSinhVien.getValueAt(row, 7).toString());
        txtDiemTichLuy.setText(tblSinhVien.getValueAt(row, 8).toString());
